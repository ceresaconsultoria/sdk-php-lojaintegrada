 ...
 * @author weslley
 */
class Produto extends LIController{
    ...
    public function alterar($id, array $payload, array $query = []){
        try{
            $response = $this->http->put("produto/".$id, array(
                "headers" => [
                    "Authorization" => sprintf("chave_api %s aplicacao %s", $this->getApiKey(), $this->getAppKey()),
                ],
                "json" => $payload,
    ...
    public function detalhes($id, array $query = []){
        try{
            $response = $this->http->get("produto/".$id, array(
                "headers" => [
                    "Authorization" => sprintf("chave_api %s aplicacao %s", $this->getApiKey(), $this->getAppKey()),
                ],
                "query" => $query,
    ...
    public function cadastrar(array $payload){
        try{
            $response = $this->http->post("produto", array(
                "headers" => [
                    "Authorization" => sprintf("chave_api %s aplicacao %s", $this->getApiKey(), $this->getAppKey())
                ],
                "json" => $payload
    ...
    public function listarTodos(array $query = []){
        try{
            $response = $this->http->get("produto", array(
                "headers" => [
                    "Authorization" => sprintf("chave_api %s aplicacao %s", $this->getApiKey(), $this->getAppKey())
                ],
                "query" => $query
