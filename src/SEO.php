 ...
 * @author weslley
 */
class SEO extends LIController{    
    public function alterar($id, array $body){
        try{
            $response = $this->http->put("seo/".$id, array(
                "headers" => [
    ...
    public function detalhes($id, array $query = []){
        try{
            $response = $this->http->get("seo/".$id, array(
                "headers" => [
                    "Authorization" => sprintf("chave_api %s aplicacao %s", $this->getApiKey(), $this->getAppKey()),
                ],
                "query" => $query,
    ...
    public function listarTodas(array $query = []){
        try{
            $response = $this->http->get("seo", array(
                "headers" => [
                    "Authorization" => sprintf("chave_api %s aplicacao %s", $this->getApiKey(), $this->getAppKey())
                ],
                "query" => $query
